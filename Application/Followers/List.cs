                    ...
                    case "followers":
                        {
                            ...
                            {
                                profiles.Add(await this._profileReader.ReadProfile(follower.Observer.UserName));
                            }
                            break;
                        }
                    case "following":
                        {
                            ...
                            foreach (var follower in userFollowings)
                            {
                                profiles.Add(await this._profileReader.ReadProfile(follower.Target.UserName));
                            }
                            break;
                        }
                }
